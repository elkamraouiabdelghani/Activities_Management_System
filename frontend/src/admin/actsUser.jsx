    ...
    return(
        <div className="container-fluid m-0 p-0 espaceadmin">
            ...
            <div className="container mx-auto p-5">
                <h1 className="text-center py-3 px-2">Les activites de participant {user.nom} {user.prenom}</h1>
                        ...
                        </tr>
                        {
                            ...
                            <tr>
                                <td className="text-center" colSpan={6}>
                                    <h1 style={{"background-color": "lightgray"}}>Aucun activite</h1>
                                </td>
                            </tr> : 
                            acts.map(act => (
